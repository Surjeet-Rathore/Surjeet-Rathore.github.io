define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/gestures', 'packages/flutter/src/gestures/arena', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__gestures, packages__flutter__src__gestures__arena, packages__vector_math__vector_math_64) {
  'use strict';
  ...
  dart.defineLazy(CT, {
    ...
    get C3() {
      return C3 = dart.constList([C1 || CT.C1, C2 || CT.C2], box_border.BoxShape);
    },
    get C5() {
    ...
    get C11() {
      return C11 = dart.const({
        ...
        bottomRight: C10 || CT.C10,
        bottomLeft: C10 || CT.C10,
        topRight: C10 || CT.C10,
        topLeft: C10 || CT.C10
      });
    },
    get C12() {
      return C12 = dart.const({
        ...
        bottomEnd: C10 || CT.C10,
        bottomStart: C10 || CT.C10,
        topEnd: C10 || CT.C10,
        topStart: C10 || CT.C10
      });
    },
    ...
    get C39() {
      return C39 = dart.fn(image_resolution.AssetImage._manifestParser, StringToFutureOfMapOfString$ListOfString());
    },
    get C41() {
    ...
    get C46() {
      return C46 = dart.constList([C42 || CT.C42, C43 || CT.C43, C44 || CT.C44, C45 || CT.C45], decoration_image.ImageRepeat);
    },
    get C47() {
    ...
    get C50() {
      return C50 = dart.constList(["null"], core.String);
    },
    get C51() {
      return C51 = dart.constList([], diagnostics.DiagnosticsNode);
    },
    get C52() {
    ...
    get C56() {
      return C56 = dart.constList([C52 || CT.C52, C53 || CT.C53, C54 || CT.C54, C55 || CT.C55], basic_types.RenderComparison);
    },
    get C57() {
      return C57 = dart.constList([C34 || CT.C34, C35 || CT.C35], basic_types.Axis);
    },
    get C58() {
    ...
    get C60() {
      return C60 = dart.constList([C58 || CT.C58, C59 || CT.C59], basic_types.VerticalDirection);
    },
    get C61() {
    ...
    get C65() {
      return C65 = dart.constList([C61 || CT.C61, C62 || CT.C62, C63 || CT.C63, C64 || CT.C64], basic_types.AxisDirection);
    },
    get C66() {
    ...
    get C68() {
      return C68 = dart.const({
        ...
        [_name$4]: "FlutterLogoStyle.markOnly",
        index: 0
      });
    },
    get C69() {
      return C69 = dart.const({
        __proto__: flutter_logo.FlutterLogoStyle.prototype,
        [_name$4]: "FlutterLogoStyle.horizontal",
        index: 1
      });
    },
    get C70() {
      return C70 = dart.const({
        __proto__: flutter_logo.FlutterLogoStyle.prototype,
        [_name$4]: "FlutterLogoStyle.stacked",
        index: 2
      });
    },
    get C71() {
      return C71 = dart.constList([C68 || CT.C68, C69 || CT.C69, C70 || CT.C70], flutter_logo.FlutterLogoStyle);
    },
    get C72() {
    ...
    get C99() {
      return C99 = dart.constList([0.7071, -0.7071, 0, 0, 0.7071, 0.7071, 0, 0, 0, 0, 1, 0, -77.697, 98.057, 0, 1], core.double);
    },
    get C100() {
      return C100 = dart.const({
        __proto__: ui.Rect.prototype,
        bottom: 162.5,
        right: 99.19999999999999,
        top: 123.1,
        left: 59.8
      });
    },
    ...
    get C114() {
      return C114 = dart.constList([C112 || CT.C112, C113 || CT.C113], text_painter.TextWidthBasis);
    },
    get C115() {
    ...
    get C136() {
      return C136 = dart.constList([C5 || CT.C5, C7 || CT.C7], borders$.BorderStyle);
    },
    get C137() {
    ...
    get C144() {
      return C144 = dart.const({
        __proto__: box_fit.BoxFit.prototype,
        [_name$6]: "BoxFit.scaleDown",
        index: 6
      });
    },
    get C145() {
      return C145 = dart.constList([C138 || CT.C138, C139 || CT.C139, C140 || CT.C140, C141 || CT.C141, C142 || CT.C142, C143 || CT.C143, C144 || CT.C144], box_fit.BoxFit);
    },
    get C147() {
  ...
  paint_utilities.paintZigZag = function paintZigZag(canvas, paint, start, end, zigs, width) {
    ...
    let path = (t0 = ui.Path.new(), t0.moveTo(0.0, 0.0), t0);
  ...
  const scale$ = Symbol("NetworkImage.scale");
  ...
  box_border.BoxShape.rectangle = C1 || CT.C1;
  box_border.BoxShape.circle = C2 || CT.C2;
  box_border.BoxShape.values = C3 || CT.C3;
  borders$.ShapeBorder = class ShapeBorder extends core.Object {
    ...
    ['+'](other) {
      let t1, t1$;
      t1$ = (t1 = this.add(other), t1 == null ? other.add(this, {reversed: true}) : t1);
      return t1$ == null ? new borders$._CompoundBorder.new(JSArrayOfShapeBorder().of([other, this])) : t1$;
    }
    lerpFrom(a, t) {
    ...
    static lerp(a, b, t) {
      ...
      t1 = result;
      return t1 == null ? dart.notNull(t) < 0.5 ? a : b : t1;
    }
    toString() {
      return dart.str(this[$runtimeType]) + "()";
    }
  ...
  box_border.BoxBorder = class BoxBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      t1 = ui.Path.new();
      t1.addRect(this.dimensions.resolve(textDirection).deflateRect(rect));
      return t1;
    }
    ...
    static _paintUniformBorderWithRadius(canvas, rect, side, borderRadius) {
      ...
      let paint = (t1 = new ui.Paint.new(), t1.color = side.color, t1);
  ...
  box_border.Border = class Border extends box_border.BoxBorder {
    ...
    static all(opts) {
      let color = opts && 'color' in opts ? opts.color : C6 || CT.C6;
      let width = opts && 'width' in opts ? opts.width : 1;
      let style = opts && 'style' in opts ? opts.style : C7 || CT.C7;
    ...
    paint(canvas, rect, opts) {
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      let shape = opts && 'shape' in opts ? opts.shape : C1 || CT.C1;
    ...
    toString() {
      ...
      let arguments$ = JSArrayOfString().of([]);
      if (!dart.equals(this.top, borders$.BorderSide.none)) arguments$[$add]("top: " + dart.str(this.top));
      if (!dart.equals(this.right, borders$.BorderSide.none)) arguments$[$add]("right: " + dart.str(this.right));
      if (!dart.equals(this.bottom, borders$.BorderSide.none)) arguments$[$add]("bottom: " + dart.str(this.bottom));
      if (!dart.equals(this.left, borders$.BorderSide.none)) arguments$[$add]("left: " + dart.str(this.left));
      return dart.str(this[$runtimeType]) + "(" + dart.str(arguments$[$join](", ")) + ")";
    }
  };
  (box_border.Border.new = function(opts) {
    let top = opts && 'top' in opts ? opts.top : C4 || CT.C4;
    let right = opts && 'right' in opts ? opts.right : C4 || CT.C4;
    let bottom = opts && 'bottom' in opts ? opts.bottom : C4 || CT.C4;
    let left = opts && 'left' in opts ? opts.left : C4 || CT.C4;
    this[top$] = top;
    this[right$] = right;
    this[bottom$] = bottom;
    this[left$] = left;
  ...
  box_border.BorderDirectional = class BorderDirectional extends box_border.BoxBorder {
    ...
    static merge(a, b) {
      if (!(a != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 596, 12, "a != null");
      if (!(b != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 597, 12, "b != null");
      if (!dart.test(borders$.BorderSide.canMerge(a.top, b.top))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 598, 12, "BorderSide.canMerge(a.top, b.top)");
      if (!dart.test(borders$.BorderSide.canMerge(a.start, b.start))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 599, 12, "BorderSide.canMerge(a.start, b.start)");
      if (!dart.test(borders$.BorderSide.canMerge(a.end, b.end))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 600, 12, "BorderSide.canMerge(a.end, b.end)");
      if (!dart.test(borders$.BorderSide.canMerge(a.bottom, b.bottom))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 601, 12, "BorderSide.canMerge(a.bottom, b.bottom)");
    ...
    add(other, opts) {
      ...
      if (box_border.Border.is(other)) {
        ...
        if (!dart.equals(this.start, borders$.BorderSide.none) || !dart.equals(this.end, borders$.BorderSide.none)) {
          ...
          if (!dart.equals(typedOther.left, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 686, 16, "typedOther.left == BorderSide.none");
          if (!dart.equals(typedOther.right, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 687, 16, "typedOther.right == BorderSide.none");
        ...
        if (!dart.equals(this.start, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 695, 14, "start == BorderSide.none");
        if (!dart.equals(this.end, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 696, 14, "end == BorderSide.none");
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 738, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b.scale(t);
      if (b == null) return a.scale(1.0 - dart.notNull(t));
    ...
    paint(canvas, rect, opts) {
        ...
        switch (this.top.style) {
          ...
          case C7 || CT.C7:
          {
            switch (shape) {
              case C2 || CT.C2:
              {
                if (!(borderRadius == null)) dart.assertFailed("A borderRadius can only be given for rectangular boxes.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 790, 22, "borderRadius == null");
                box_border.BoxBorder._paintUniformBorderWithCircle(canvas, rect, this.top);
                break;
              }
              case C1 || CT.C1:
      ...
      if (!(borderRadius == null)) dart.assertFailed("A borderRadius can only be given for uniform borders.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 805, 12, "borderRadius == null");
      if (!dart.equals(shape, box_border.BoxShape.rectangle)) dart.assertFailed("A border can only be drawn as a circle if it is uniform.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 806, 12, "shape == BoxShape.rectangle");
      let left = null;
      let right = null;
      if (!(textDirection != null)) dart.assertFailed("Non-uniform BorderDirectional objects require a TextDirection when painting.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 809, 12, "textDirection != null");
    ...
    toString() {
      let arguments$ = JSArrayOfString().of([]);
      if (!dart.equals(this.top, borders$.BorderSide.none)) arguments$[$add]("top: " + dart.str(this.top));
      if (!dart.equals(this.start, borders$.BorderSide.none)) arguments$[$add]("start: " + dart.str(this.start));
      if (!dart.equals(this.end, borders$.BorderSide.none)) arguments$[$add]("end: " + dart.str(this.end));
      if (!dart.equals(this.bottom, borders$.BorderSide.none)) arguments$[$add]("bottom: " + dart.str(this.bottom));
      return dart.str(this[$runtimeType]) + "(" + dart.str(arguments$[$join](", ")) + ")";
    }
  };
  (box_border.BorderDirectional.new = function(opts) {
    let top = opts && 'top' in opts ? opts.top : C4 || CT.C4;
    let start = opts && 'start' in opts ? opts.start : C4 || CT.C4;
    let end = opts && 'end' in opts ? opts.end : C4 || CT.C4;
    let bottom = opts && 'bottom' in opts ? opts.bottom : C4 || CT.C4;
    this[top$0] = top;
    this[start$] = start;
    this[end$] = end;
    this[bottom$0] = bottom;
    if (!(top != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 583, 15, "top != null");
    if (!(start != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 584, 15, "start != null");
    if (!(end != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 585, 15, "end != null");
    if (!(bottom != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 586, 15, "bottom != null");
  ...
  const top$0 = Symbol("BorderDirectional.top");
  const start$ = Symbol("BorderDirectional.start");
  const end$ = Symbol("BorderDirectional.end");
  const bottom$0 = Symbol("BorderDirectional.bottom");
  ...
  (border_radius.BorderRadius.vertical = function(opts) {
    let top = opts && 'top' in opts ? opts.top : C10 || CT.C10;
    let bottom = opts && 'bottom' in opts ? opts.bottom : C10 || CT.C10;
  ...
  (border_radius.BorderRadius.horizontal = function(opts) {
    let left = opts && 'left' in opts ? opts.left : C10 || CT.C10;
    let right = opts && 'right' in opts ? opts.right : C10 || CT.C10;
  ...
  (border_radius.BorderRadius.only = function(opts) {
    let topLeft = opts && 'topLeft' in opts ? opts.topLeft : C10 || CT.C10;
    let topRight = opts && 'topRight' in opts ? opts.topRight : C10 || CT.C10;
    let bottomLeft = opts && 'bottomLeft' in opts ? opts.bottomLeft : C10 || CT.C10;
    let bottomRight = opts && 'bottomRight' in opts ? opts.bottomRight : C10 || CT.C10;
  ...
  (border_radius.BorderRadiusDirectional.horizontal = function(opts) {
    let start = opts && 'start' in opts ? opts.start : C10 || CT.C10;
    let end = opts && 'end' in opts ? opts.end : C10 || CT.C10;
  ...
  (border_radius.BorderRadiusDirectional.only = function(opts) {
    let topStart = opts && 'topStart' in opts ? opts.topStart : C10 || CT.C10;
    let topEnd = opts && 'topEnd' in opts ? opts.topEnd : C10 || CT.C10;
    let bottomStart = opts && 'bottomStart' in opts ? opts.bottomStart : C10 || CT.C10;
    let bottomEnd = opts && 'bottomEnd' in opts ? opts.bottomEnd : C10 || CT.C10;
  ...
  const _start$0 = dart.privateName(edge_insets, "_start");
  ...
  edge_insets.EdgeInsetsGeometry = class EdgeInsetsGeometry extends core.Object {
    get isNonNegative() {
      return dart.notNull(this[_left]) >= 0.0 && dart.notNull(this[_right]) >= 0.0 && dart.notNull(this[_start$0]) >= 0.0 && dart.notNull(this[_end]) >= 0.0 && dart.notNull(this[_top]) >= 0.0 && dart.notNull(this[_bottom]) >= 0.0;
    }
    get horizontal() {
      return dart.notNull(this[_left]) + dart.notNull(this[_right]) + dart.notNull(this[_start$0]) + dart.notNull(this[_end]);
    }
    get vertical() {
    ...
    get flipped() {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(this[_right], this[_left], this[_end], this[_start$0], this[_bottom], this[_top]);
    }
    inflateSize(size) {
    ...
    subtract(other) {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(dart.notNull(this[_left]) - dart.notNull(other[_left]), dart.notNull(this[_right]) - dart.notNull(other[_right]), dart.notNull(this[_start$0]) - dart.notNull(other[_start$0]), dart.notNull(this[_end]) - dart.notNull(other[_end]), dart.notNull(this[_top]) - dart.notNull(other[_top]), dart.notNull(this[_bottom]) - dart.notNull(other[_bottom]));
    }
    add(other) {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(dart.notNull(this[_left]) + dart.notNull(other[_left]), dart.notNull(this[_right]) + dart.notNull(other[_right]), dart.notNull(this[_start$0]) + dart.notNull(other[_start$0]), dart.notNull(this[_end]) + dart.notNull(other[_end]), dart.notNull(this[_top]) + dart.notNull(other[_top]), dart.notNull(this[_bottom]) + dart.notNull(other[_bottom]));
    }
    static lerp(a, b, t) {
      ...
      return new edge_insets._MixedEdgeInsets.fromLRSETB(ui.lerpDouble(a[_left], b[_left], t), ui.lerpDouble(a[_right], b[_right], t), ui.lerpDouble(a[_start$0], b[_start$0], t), ui.lerpDouble(a[_end], b[_end], t), ui.lerpDouble(a[_top], b[_top], t), ui.lerpDouble(a[_bottom], b[_bottom], t));
    }
    toString() {
      if (this[_start$0] === 0.0 && this[_end] === 0.0) {
      ...
      if (this[_left] === 0.0 && this[_right] === 0.0) {
        return "EdgeInsetsDirectional(" + this[_start$0][$toStringAsFixed](1) + ", " + this[_top][$toStringAsFixed](1) + ", " + this[_end][$toStringAsFixed](1) + ", " + this[_bottom][$toStringAsFixed](1) + ")";
      }
      return "EdgeInsets(" + this[_left][$toStringAsFixed](1) + ", " + this[_top][$toStringAsFixed](1) + ", " + this[_right][$toStringAsFixed](1) + ", " + this[_bottom][$toStringAsFixed](1) + ")" + " + " + "EdgeInsetsDirectional(" + this[_start$0][$toStringAsFixed](1) + ", " + "0.0, " + this[_end][$toStringAsFixed](1) + ", " + "0.0)";
    }
    _equals(other) {
      if (other == null) return false;
      if (!edge_insets.EdgeInsetsGeometry.is(other)) return false;
      let typedOther = edge_insets.EdgeInsetsGeometry._check(other);
      return this[_left] == typedOther[_left] && this[_right] == typedOther[_right] && this[_start$0] == typedOther[_start$0] && this[_end] == typedOther[_end] && this[_top] == typedOther[_top] && this[_bottom] == typedOther[_bottom];
    }
    get hashCode() {
      return ui.hashValues(this[_left], this[_right], this[_start$0], this[_end], this[_top], this[_bottom]);
    }
  };
  ...
  edge_insets.EdgeInsets = class EdgeInsets extends edge_insets.EdgeInsetsGeometry {
    ...
    copyWith(opts) {
      ...
      return new edge_insets.EdgeInsets.only({left: (t1 = left, t1 == null ? this.left : t1), top: (t1$ = top, t1$ == null ? this.top : t1$), right: (t1$0 = right, t1$0 == null ? this.right : t1$0), bottom: (t1$1 = bottom, t1$1 == null ? this.bottom : t1$1)});
    }
  };
  ...
  (edge_insets.EdgeInsets.fromWindowPadding = function(padding, devicePixelRatio) {
    this[left$0] = dart.notNull(padding.left) / dart.notNull(devicePixelRatio);
    this[top$1] = dart.notNull(padding.top) / dart.notNull(devicePixelRatio);
    this[right$0] = dart.notNull(padding.right) / dart.notNull(devicePixelRatio);
    this[bottom$1] = dart.notNull(padding.bottom) / dart.notNull(devicePixelRatio);
    edge_insets.EdgeInsets.__proto__.new.call(this);
    ;
  }).prototype = edge_insets.EdgeInsets.prototype;
  dart.addTypeTests(edge_insets.EdgeInsets);
  const left$0 = Symbol("EdgeInsets.left");
  const top$1 = Symbol("EdgeInsets.top");
  const right$0 = Symbol("EdgeInsets.right");
  const bottom$1 = Symbol("EdgeInsets.bottom");
  ...
  const start$1 = Symbol("EdgeInsetsDirectional.start");
  const top$2 = Symbol("EdgeInsetsDirectional.top");
  const end$0 = Symbol("EdgeInsetsDirectional.end");
  const bottom$2 = Symbol("EdgeInsetsDirectional.bottom");
  ...
  edge_insets._MixedEdgeInsets = class _MixedEdgeInsets extends edge_insets.EdgeInsetsGeometry {
    ...
    _negate() {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(-dart.notNull(this[_left]), -dart.notNull(this[_right]), -dart.notNull(this[_start$0]), -dart.notNull(this[_end]), -dart.notNull(this[_top]), -dart.notNull(this[_bottom]));
    }
    ['*'](other) {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(dart.notNull(this[_left]) * dart.notNull(other), dart.notNull(this[_right]) * dart.notNull(other), dart.notNull(this[_start$0]) * dart.notNull(other), dart.notNull(this[_end]) * dart.notNull(other), dart.notNull(this[_top]) * dart.notNull(other), dart.notNull(this[_bottom]) * dart.notNull(other));
    }
    ['/'](other) {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(dart.notNull(this[_left]) / dart.notNull(other), dart.notNull(this[_right]) / dart.notNull(other), dart.notNull(this[_start$0]) / dart.notNull(other), dart.notNull(this[_end]) / dart.notNull(other), dart.notNull(this[_top]) / dart.notNull(other), dart.notNull(this[_bottom]) / dart.notNull(other));
    }
    ['~/'](other) {
      return new edge_insets._MixedEdgeInsets.fromLRSETB((dart.notNull(this[_left]) / dart.notNull(other))[$truncate]()[$toDouble](), (dart.notNull(this[_right]) / dart.notNull(other))[$truncate]()[$toDouble](), (dart.notNull(this[_start$0]) / dart.notNull(other))[$truncate]()[$toDouble](), (dart.notNull(this[_end]) / dart.notNull(other))[$truncate]()[$toDouble](), (dart.notNull(this[_top]) / dart.notNull(other))[$truncate]()[$toDouble](), (dart.notNull(this[_bottom]) / dart.notNull(other))[$truncate]()[$toDouble]());
    }
    ['%'](other) {
      return new edge_insets._MixedEdgeInsets.fromLRSETB(this[_left][$modulo](other), this[_right][$modulo](other), this[_start$0][$modulo](other), this[_end][$modulo](other), this[_top][$modulo](other), this[_bottom][$modulo](other));
    }
    resolve(direction) {
      ...
      switch (direction) {
        case C8 || CT.C8:
        {
          return new edge_insets.EdgeInsets.fromLTRB(dart.notNull(this[_end]) + dart.notNull(this[_left]), this[_top], dart.notNull(this[_start$0]) + dart.notNull(this[_right]), this[_bottom]);
        }
        case C9 || CT.C9:
        {
          return new edge_insets.EdgeInsets.fromLTRB(dart.notNull(this[_start$0]) + dart.notNull(this[_left]), this[_top], dart.notNull(this[_end]) + dart.notNull(this[_right]), this[_bottom]);
        }
      }
      return null;
    }
  ...
  const _left$ = Symbol("_MixedEdgeInsets._left");
  const _right$ = Symbol("_MixedEdgeInsets._right");
  const _start$1 = Symbol("_MixedEdgeInsets._start");
  const _end$ = Symbol("_MixedEdgeInsets._end");
  const _top$ = Symbol("_MixedEdgeInsets._top");
  const _bottom$ = Symbol("_MixedEdgeInsets._bottom");
  ...
  gradient.LinearGradient = class LinearGradient extends gradient.Gradient {
    ...
    _equals(other) {
      ...
      if (!dart.equals(this.begin, typedOther.begin) || !dart.equals(this.end, typedOther.end) || !dart.equals(this.tileMode, typedOther.tileMode) || (t1 = this.colors, t1 == null ? null : t1[$length]) != (t1$ = typedOther.colors, t1$ == null ? null : t1$[$length]) || (t1$0 = this.stops, t1$0 == null ? null : t1$0[$length]) != (t1$1 = typedOther.stops, t1$1 == null ? null : t1$1[$length])) return false;
      if (this.colors != null) {
  ...
  (gradient.LinearGradient.new = function(opts) {
    let begin = opts && 'begin' in opts ? opts.begin : C16 || CT.C16;
    let end = opts && 'end' in opts ? opts.end : C18 || CT.C18;
    let colors = opts && 'colors' in opts ? opts.colors : null;
    let stops = opts && 'stops' in opts ? opts.stops : null;
    let tileMode = opts && 'tileMode' in opts ? opts.tileMode : C38 || CT.C38;
    this[begin$] = begin;
    this[end$1] = end;
  ...
  gradient.RadialGradient = class RadialGradient extends gradient.Gradient {
    ...
    _equals(other) {
      ...
      if (!dart.equals(this.center, typedOther.center) || this.radius != typedOther.radius || !dart.equals(this.tileMode, typedOther.tileMode) || (t1 = this.colors, t1 == null ? null : t1[$length]) != (t1$ = typedOther.colors, t1$ == null ? null : t1$[$length]) || (t1$0 = this.stops, t1$0 == null ? null : t1$0[$length]) != (t1$1 = typedOther.stops, t1$1 == null ? null : t1$1[$length]) || !dart.equals(this.focal, typedOther.focal) || this.focalRadius != typedOther.focalRadius) return false;
      if (this.colors != null) {
  ...
  (gradient.RadialGradient.new = function(opts) {
    let center = opts && 'center' in opts ? opts.center : C17 || CT.C17;
  ...
  gradient.SweepGradient = class SweepGradient extends gradient.Gradient {
    ...
    _equals(other) {
      ...
      if (!dart.equals(this.center, typedOther.center) || this.startAngle != typedOther.startAngle || this.endAngle != typedOther.endAngle || !dart.equals(this.tileMode, typedOther.tileMode) || (t1 = this.colors, t1 == null ? null : t1[$length]) != (t1$ = typedOther.colors, t1$ == null ? null : t1$[$length]) || (t1$0 = this.stops, t1$0 == null ? null : t1$0[$length]) != (t1$1 = typedOther.stops, t1$1 == null ? null : t1$1[$length])) return false;
      if (this.colors != null) {
  ...
  gradient._interpolateColorsAndStops = function _interpolateColorsAndStops(aColors, aStops, bColors, bStops, t) {
    ...
    let stops = (t1 = new (SplayTreeSetOfdouble()).new(), t1.addAll(aStops), t1.addAll(bStops), t1);
  ...
  notched_shapes.CircularNotchedRectangle = class CircularNotchedRectangle extends notched_shapes.NotchedShape {
    getOuterPath(host, guest) {
      ...
      for (let i = 0; i < dart.notNull(p[$length]); i = i + 1) {
        t1$ = p;
        t2 = i;
        t1$[$_set](t2, t1$[$_get](t2)['+'](guest.center));
      }
      t1$0 = ui.Path.new();
      t1$0.moveTo(host.left, host.top);
      t1$0.lineTo(p[$_get](0).dx, p[$_get](0).dy);
      t1$0.quadraticBezierTo(p[$_get](1).dx, p[$_get](1).dy, p[$_get](2).dx, p[$_get](2).dy);
      t1$0.arcToPoint(p[$_get](3), {radius: new ui.Radius.circular(notchRadius), clockwise: false});
      t1$0.quadraticBezierTo(p[$_get](4).dx, p[$_get](4).dy, p[$_get](5).dx, p[$_get](5).dy);
      t1$0.lineTo(host.right, host.top);
      t1$0.lineTo(host.right, host.bottom);
      t1$0.lineTo(host.left, host.bottom);
      t1$0.close();
      return t1$0;
    }
  };
  ...
  const host$ = Symbol("AutomaticNotchedShape.host");
  const guest$ = Symbol("AutomaticNotchedShape.guest");
  ...
  const scale$0 = Symbol("ImageInfo.scale");
  ...
  const onImage$ = Symbol("ImageStreamListener.onImage");
  const onChunk$ = Symbol("ImageStreamListener.onChunk");
  const onError$ = Symbol("ImageStreamListener.onError");
  ...
  const cumulativeBytesLoaded$ = Symbol("ImageChunkEvent.cumulativeBytesLoaded");
  const expectedTotalBytes$ = Symbol("ImageChunkEvent.expectedTotalBytes");
  ...
  image_stream.ImageStream = class ImageStream extends diagnostics.Diagnosticable {
    ...
    debugFillProperties(properties) {
      let t1, t1$, t1$0, t1$1;
      super.debugFillProperties(properties);
      properties.add(new (ObjectFlagPropertyOfImageStreamCompleter()).new("completer", this[_completer], {ifPresent: (t1 = this[_completer], t1 == null ? null : t1.toStringShort()), ifNull: "unresolved"}));
      properties.add(new (ObjectFlagPropertyOfListOfImageStreamListener()).new("listeners", this[_listeners], {ifPresent: dart.str((t1$ = this[_listeners], t1$ == null ? null : t1$[$length])) + " listener" + ((t1$0 = this[_listeners], t1$0 == null ? null : t1$0[$length]) === 1 ? "" : "s"), ifNull: "no listeners", level: this[_completer] != null ? diagnostics.DiagnosticLevel.hidden : diagnostics.DiagnosticLevel.info}));
      t1$1 = this[_completer];
      t1$1 == null ? null : t1$1.debugFillProperties(properties);
    }
  };
  ...
  image_stream.ImageStreamCompleter = class ImageStreamCompleter extends diagnostics.Diagnosticable {
    ...
    debugFillProperties(description) {
      ...
      description.add(new (ObjectFlagPropertyOfListOfImageStreamListener()).new("listeners", this[_listeners], {ifPresent: dart.str((t5 = this[_listeners], t5 == null ? null : t5[$length])) + " listener" + ((t5$ = this[_listeners], t5$ == null ? null : t5$[$length]) === 1 ? "" : "s")}));
    }
  };
  ...
  const scale$1 = Symbol("AssetBundleImageKey.scale");
  ...
  image_resolution.AssetImage = class AssetImage extends image_provider.AssetBundleImageProvider {
    ...
    obtainKey(configuration) {
      let t6, t6$;
      let chosenBundle = (t6$ = (t6 = this.bundle, t6 == null ? configuration.bundle : t6), t6$ == null ? asset_bundle.rootBundle : t6$);
      let completer = null;
      let result = null;
      chosenBundle.loadStructuredData(MapOfString$ListOfString(), "AssetManifest.json", C39 || CT.C39).then(dart.void, dart.fn(manifest => {
  ...
  beveled_rectangle_border.BeveledRectangleBorder = class BeveledRectangleBorder extends borders$.ShapeBorder {
    ...
    paint(canvas, rect, opts) {
      ...
      switch (this.side.style) {
        ...
        case C7 || CT.C7:
        {
          let path = (t6 = this.getOuterPath(rect, {textDirection: textDirection}), t6.addPath(this.getInnerPath(rect, {textDirection: textDirection}), ui.Offset.zero), t6);
  ...
  (beveled_rectangle_border.BeveledRectangleBorder.new = function(opts) {
    let side = opts && 'side' in opts ? opts.side : C4 || CT.C4;
  ...
  const side$ = Symbol("BeveledRectangleBorder.side");
  const borderRadius$ = Symbol("BeveledRectangleBorder.borderRadius");
  ...
  binding$1.PaintingBinding[dart.implements] = () => [binding$0.ServicesBinding, binding.BindingBase];
  ...
  decoration_image.ImageRepeat.repeat = C42 || CT.C42;
  decoration_image.ImageRepeat.repeatX = C43 || CT.C43;
  decoration_image.ImageRepeat.repeatY = C44 || CT.C44;
  decoration_image.ImageRepeat.noRepeat = C45 || CT.C45;
  decoration_image.ImageRepeat.values = C46 || CT.C46;
  decoration_image.DecorationImage = class DecorationImage extends core.Object {
    ...
    toString() {
      let properties = JSArrayOfString().of([]);
      properties[$add](dart.str(this.image));
      if (this.colorFilter != null) properties[$add](dart.str(this.colorFilter));
      if (this.fit != null && !(dart.equals(this.fit, box_fit.BoxFit.fill) && this.centerSlice != null) && !(dart.equals(this.fit, box_fit.BoxFit.scaleDown) && this.centerSlice == null)) properties[$add](dart.str(this.fit));
      properties[$add](dart.str(this.alignment));
      if (this.centerSlice != null) properties[$add]("centerSlice: " + dart.str(this.centerSlice));
      if (!dart.equals(this.repeat, decoration_image.ImageRepeat.noRepeat)) properties[$add](dart.str(this.repeat));
      if (dart.test(this.matchTextDirection)) properties[$add]("match text direction");
  ...
  (decoration_image.DecorationImage.new = function(opts) {
    ...
    let alignment = opts && 'alignment' in opts ? opts.alignment : C17 || CT.C17;
    let centerSlice = opts && 'centerSlice' in opts ? opts.centerSlice : null;
    let repeat = opts && 'repeat' in opts ? opts.repeat : C45 || CT.C45;
  ...
  const image$0 = Symbol("DecorationImage.image");
  const colorFilter$ = Symbol("DecorationImage.colorFilter");
  const fit$ = Symbol("DecorationImage.fit");
  const alignment$ = Symbol("DecorationImage.alignment");
  const centerSlice$ = Symbol("DecorationImage.centerSlice");
  const repeat$ = Symbol("DecorationImage.repeat");
  const matchTextDirection$ = Symbol("DecorationImage.matchTextDirection");
  ...
  decoration_image.DecorationImagePainter = class DecorationImagePainter extends core.Object {
    paint(canvas, rect, clipPath, configuration) {
      let t6, t6$;
      if (!(canvas != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 213, 12, "canvas != null");
      if (!(rect != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 214, 12, "rect != null");
      if (!(configuration != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 215, 12, "configuration != null");
      ...
      if (!dart.equals(newImageStream.key, (t6 = this[_imageStream], t6 == null ? null : t6.key))) {
        let listener = new image_stream.ImageStreamListener.new(dart.bind(this, _handleImage));
        t6$ = this[_imageStream];
        t6$ == null ? null : t6$.removeListener(listener);
    ...
    [_handleImage](value, synchronousCall) {
      ...
      this[_image] = value;
      if (!(this[_onChanged$] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 276, 12, "_onChanged != null");
      if (!dart.test(synchronousCall)) this[_onChanged$]();
    }
    dispose() {
      let t6;
      t6 = this[_imageStream];
      t6 == null ? null : t6.removeListener(new image_stream.ImageStreamListener.new(dart.bind(this, _handleImage)));
    }
    toString() {
  ...
  (decoration_image.DecorationImagePainter.__ = function(_details, _onChanged) {
    ...
    if (!(_details != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 190, 69, "_details != null");
    ;
  ...
  decoration_image.paintImage = function paintImage(opts) {
    ...
    let filterQuality = opts && 'filterQuality' in opts ? opts.filterQuality : C47 || CT.C47;
    if (!(canvas != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 379, 10, "canvas != null");
    if (!(image != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 380, 10, "image != null");
    if (!(alignment != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 381, 10, "alignment != null");
    if (!(repeat != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 382, 10, "repeat != null");
    if (!(flipHorizontally != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 383, 10, "flipHorizontally != null");
    if (dart.test(rect.isEmpty)) return;
    ...
    if (!(centerSlice == null || !dart.equals(fit, box_fit.BoxFit.none) && !dart.equals(fit, box_fit.BoxFit.cover))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 398, 10, "centerSlice == null || (fit != BoxFit.none && fit != BoxFit.cover)");
    ...
    if (centerSlice != null) {
      ...
      if (!dart.equals(sourceSize, inputSize)) dart.assertFailed("centerSlice was used with a BoxFit that does not guarantee that the image is fully visible.", "org-dartlang-app:///packages/flutter/src/painting/decoration_image.dart", 407, 12, "sourceSize == inputSize");
    }
    ...
    let paint = (t6 = new ui.Paint.new(), t6.isAntiAlias = false, t6);
  ...
  matrix_utils.MatrixUtils = class MatrixUtils extends core.Object {
    ...
    static _accumulate(m, x, y, first, isAffine) {
      ...
      if (dart.test(first)) {
        matrix_utils.MatrixUtils._minMax[$_set](0, (t6 = matrix_utils.MatrixUtils._minMax, t7 = 2, t8 = tx, t6[$_set](t7, t8), t8));
        matrix_utils.MatrixUtils._minMax[$_set](1, (t6$ = matrix_utils.MatrixUtils._minMax, t7$ = 3, t8$ = ty, t6$[$_set](t7$, t8$), t8$));
      } else {
    ...
    static inverseTransformRect(transform, rect) {
      ...
      transform = (t6 = vector_math_64.Matrix4.copy(transform), t6.invert(), t6);
    ...
    static createCylindricalProjectionTransform(opts) {
      ...
      let orientation = opts && 'orientation' in opts ? opts.orientation : C35 || CT.C35;
      ...
      let result = (t6 = vector_math_64.Matrix4.identity(), t6.setEntry(3, 2, -dart.notNull(perspective)), t6.setEntry(2, 3, -dart.notNull(radius)), t6.setEntry(3, 3, dart.notNull(perspective) * dart.notNull(radius) + 1.0), t6);
    ...
    static forceToPoint(offset) {
      let t6;
      t6 = vector_math_64.Matrix4.identity();
      t6.setRow(0, vector_math_64.Vector4.new(0.0, 0.0, 0.0, offset.dx));
      t6.setRow(1, vector_math_64.Vector4.new(0.0, 0.0, 0.0, offset.dy));
      return t6;
    }
  };
  ...
  (matrix_utils.TransformProperty.new = function(name, value, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C48 || CT.C48;
    let level = opts && 'level' in opts ? opts.level : C49 || CT.C49;
  ...
  matrix_utils.debugDescribeTransform = function debugDescribeTransform(transform) {
    if (transform == null) return C50 || CT.C50;
  ...
  continuous_rectangle_border.ContinuousRectangleBorder = class ContinuousRectangleBorder extends borders$.ShapeBorder {
    ...
    [_getPath$](rrect) {
      ...
      t6 = ui.Path.new();
      t6.moveTo(left, dart.notNull(top) + tlRadiusX);
      t6.cubicTo(left, top, left, top, dart.notNull(left) + tlRadiusY, top);
      t6.lineTo(dart.notNull(right) - trRadiusX, top);
      t6.cubicTo(right, top, right, top, right, dart.notNull(top) + trRadiusY);
      t6.lineTo(right, dart.notNull(bottom) - blRadiusX);
      t6.cubicTo(right, bottom, right, bottom, dart.notNull(right) - blRadiusY, bottom);
      t6.lineTo(dart.notNull(left) + brRadiusX, bottom);
      t6.cubicTo(left, bottom, left, bottom, left, dart.notNull(bottom) - brRadiusY);
      t6.close();
      return t6;
    }
    getInnerPath(rect, opts) {
  ...
  const borderRadius$0 = Symbol("ContinuousRectangleBorder.borderRadius");
  const side$0 = Symbol("ContinuousRectangleBorder.side");
  ...
  stadium_border.StadiumBorder = class StadiumBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      t6 = ui.Path.new();
      t6.addRRect(new ui.RRect.fromRectAndRadius(rect, radius).deflate(this.side.width));
      return t6;
    }
    getOuterPath(rect, opts) {
      let t6;
      ...
      let radius = new ui.Radius.circular(dart.notNull(rect.shortestSide) / 2.0);
      t6 = ui.Path.new();
      t6.addRRect(new ui.RRect.fromRectAndRadius(rect, radius));
      return t6;
    }
    paint(canvas, rect, opts) {
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
  ...
  const side$1 = Symbol("StadiumBorder.side");
  ...
  stadium_border._StadiumToCircleBorder = class _StadiumToCircleBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this[_adjustBorderRadius](rect).toRRect(this[_adjustRect](rect)).deflate(this.side.width));
      return t6;
    }
    getOuterPath(rect, opts) {
      let t6;
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this[_adjustBorderRadius](rect).toRRect(this[_adjustRect](rect)));
      return t6;
    }
    paint(canvas, rect, opts) {
      let t6;
      ...
      switch (this.side.style) {
        ...
        case C7 || CT.C7:
        {
          ...
          if (width === 0.0) {
            ...
            let inner = outer.deflate(width);
            let paint = (t6 = new ui.Paint.new(), t6.color = this.side.color, t6);
            canvas.drawDRRect(outer, inner, paint);
          }
        }
      }
  ...
  stadium_border._StadiumToRoundedRectangleBorder = class _StadiumToRoundedRectangleBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this[_adjustBorderRadius](rect).toRRect(rect).deflate(this.side.width));
      return t6;
    }
    getOuterPath(rect, opts) {
      let t6;
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this[_adjustBorderRadius](rect).toRRect(rect));
      return t6;
    }
    paint(canvas, rect, opts) {
      let t6;
  ...
  const style$ = Symbol("InlineSpan.style");
  ...
  text_span.TextSpan = class TextSpan extends inline_span.InlineSpan {
    ...
    describeSemantics(offset, semanticsOffsets, semanticsElements) {
      ...
      if (this.recognizer != null && (tap.TapGestureRecognizer.is(this.recognizer) || long_press.LongPressGestureRecognizer.is(this.recognizer))) {
        let length = (t6$ = (t6 = this.semanticsLabel, t6 == null ? null : t6.length), t6$ == null ? this.text.length : t6$);
    ...
    compareTo(other) {
      ...
      if (textSpan.text != this.text || (t6 = this.children, t6 == null ? null : t6[$length]) != (t6$ = textSpan.children, t6$ == null ? null : t6$[$length]) || !(this.style == null)[$_equals](textSpan.style == null)) return basic_types.RenderComparison.layout;
    ...
    debugFillProperties(properties) {
      ...
      properties.add(new (DiagnosticsPropertyOfGestureRecognizer()).new("recognizer", this.recognizer, {description: (t6$ = (t6 = this.recognizer, t6 == null ? null : dart.runtimeType(t6)), t6$ == null ? null : dart.toString(t6$)), defaultValue: null}));
      if (this.semanticsLabel != null) {
        properties.add(new diagnostics.StringProperty.new("semanticsLabel", this.semanticsLabel));
      }
    }
    debugDescribeChildren() {
      if (this.children == null) return C51 || CT.C51;
  ...
  image_provider.FileImage = class FileImage extends image_provider.ImageProvider {
    ...
    load(key) {
      ...
      return new image_stream.MultiFrameImageStreamCompleter.new({codec: this[_loadAsync$](key), scale: key.scale, informationCollector: dart.fn(() => new (SyncIterableOfErrorDescription()).new((function*() {
          let t6;
          yield new assertions.ErrorDescription.new("Path: " + dart.str((t6 = this.file, t6 == null ? null : t6.path)));
    ...
    _equals(other) {
      ...
      return (t6 = this.file, t6 == null ? null : t6.path) == (t6$ = typedOther.file, t6$ == null ? null : t6$.path) && this.scale == typedOther.scale;
    }
    get hashCode() {
      let t6;
      return ui.hashValues((t6 = this.file, t6 == null ? null : t6.path), this.scale);
    }
    toString() {
      let t6;
      return dart.str(this[$runtimeType]) + "(\"" + dart.str((t6 = this.file, t6 == null ? null : t6.path)) + "\", scale: " + dart.str(this.scale) + ")";
    }
  };
  ...
  const file$ = Symbol("FileImage.file");
  const scale$2 = Symbol("FileImage.scale");
  ...
  const scale$3 = Symbol("MemoryImage.scale");
  ...
  image_provider.ExactAssetImage = class ExactAssetImage extends image_provider.AssetBundleImageProvider {
    ...
    obtainKey(configuration) {
      let t6, t6$;
      return new (SynchronousFutureOfAssetBundleImageKey()).new(new image_provider.AssetBundleImageKey.new({bundle: (t6$ = (t6 = this.bundle, t6 == null ? configuration.bundle : t6), t6$ == null ? asset_bundle.rootBundle : t6$), name: this.keyName, scale: this.scale}));
    }
    _equals(other) {
      if (other == null) return false;
      if (!dart.equals(dart.runtimeType(other), this[$runtimeType])) return false;
  ...
  const scale$4 = Symbol("ExactAssetImage.scale");
  ...
  const statusCode$ = Symbol("NetworkImageLoadException.statusCode");
  const uri$ = Symbol("NetworkImageLoadException.uri");
  ...
  basic_types.RenderComparison.identical = C52 || CT.C52;
  basic_types.RenderComparison.metadata = C53 || CT.C53;
  basic_types.RenderComparison.paint = C54 || CT.C54;
  basic_types.RenderComparison.layout = C55 || CT.C55;
  basic_types.RenderComparison.values = C56 || CT.C56;
  let C57;
  ...
  basic_types.Axis.horizontal = C34 || CT.C34;
  basic_types.Axis.vertical = C35 || CT.C35;
  basic_types.Axis.values = C57 || CT.C57;
  let C58;
  let C59;
  let C60;
  ...
  basic_types.VerticalDirection.up = C58 || CT.C58;
  basic_types.VerticalDirection.down = C59 || CT.C59;
  basic_types.VerticalDirection.values = C60 || CT.C60;
  let C61;
  let C62;
  let C63;
  let C64;
  ...
  basic_types.AxisDirection.up = C61 || CT.C61;
  basic_types.AxisDirection.right = C62 || CT.C62;
  basic_types.AxisDirection.down = C63 || CT.C63;
  basic_types.AxisDirection.left = C64 || CT.C64;
  basic_types.AxisDirection.values = C65 || CT.C65;
  ...
  decoration.Decoration = class Decoration extends diagnostics.Diagnosticable {
    ...
    static lerp(a, b, t) {
      ...
      if (t === 0.0) return a;
      if (t === 1.0) return b;
      t6$1 = (t6$0 = b.lerpFrom(a, t), t6$0 == null ? a.lerpTo(b, t) : t6$0);
      return t6$1 == null ? dart.notNull(t) < 0.5 ? (t7 = a.lerpTo(null, dart.notNull(t) * 2.0), t7 == null ? a : t7) : (t7$ = b.lerpFrom(null, (dart.notNull(t) - 0.5) * 2.0), t7$ == null ? b : t7$) : t6$1;
    }
  ...
  const onChanged$ = Symbol("BoxPainter.onChanged");
  ...
  (placeholder_span.PlaceholderSpan.new = function(opts) {
    let alignment = opts && 'alignment' in opts ? opts.alignment : C66 || CT.C66;
  ...
  const alignment$0 = Symbol("PlaceholderSpan.alignment");
  const baseline$ = Symbol("PlaceholderSpan.baseline");
  ...
  circle_border.CircleBorder = class CircleBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addOval(new ui.Rect.fromCircle({center: rect.center, radius: math.max(core.double, 0.0, dart.notNull(rect.shortestSide) / 2.0 - dart.notNull(this.side.width))}));
      return t6;
    }
    getOuterPath(rect, opts) {
      let t6;
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addOval(new ui.Rect.fromCircle({center: rect.center, radius: dart.notNull(rect.shortestSide) / 2.0}));
      return t6;
    }
    paint(canvas, rect, opts) {
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
  ...
  const side$2 = Symbol("CircleBorder.side");
  ...
  strut_style.StrutStyle = class StrutStyle extends diagnostics.Diagnosticable {
    ...
    inheritFromTextStyle(other) {
      ...
      return new strut_style.StrutStyle.new({fontFamily: (t6 = this.fontFamily, t6 == null ? other.fontFamily : t6), fontFamilyFallback: (t6$ = this.fontFamilyFallback, t6$ == null ? other.fontFamilyFallback : t6$), fontSize: (t6$0 = this.fontSize, t6$0 == null ? other.fontSize : t6$0), height: (t6$1 = this.height, t6$1 == null ? other.height : t6$1), leading: this.leading, fontWeight: (t6$2 = this.fontWeight, t6$2 == null ? other.fontWeight : t6$2), fontStyle: (t6$3 = this.fontStyle, t6$3 == null ? other.fontStyle : t6$3), forceStrutHeight: this.forceStrutHeight, debugLabel: (t6$4 = this.debugLabel, t6$4 == null ? other.debugLabel : t6$4)});
    }
    _equals(other) {
      if (other == null) return false;
      if (this === other) return true;
  ...
  (strut_style.StrutStyle.new = function(opts) {
    ...
    if (!(package$1 == null || package$1 != null && (fontFamily != null || fontFamilyFallback != null))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 312, 15, "t(package == null || (package != null && (fontFamily != null || fontFamilyFallback != null");
  ...
  (strut_style.StrutStyle.fromTextStyle = function(textStyle, opts) {
    ...
    if (!(package$1 == null || package$1 != null && (fontFamily != null || fontFamilyFallback != null))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 348, 15, "t(package == null || (package != null && (fontFamily != null || fontFamilyFallback != null");
    this[fontFamily$] = fontFamily != null ? package$1 == null ? fontFamily : "packages/" + dart.str(package$1) + "/" + dart.str(fontFamily) : textStyle.fontFamily;
    this[_fontFamilyFallback] = (t6 = fontFamilyFallback, t6 == null ? textStyle.fontFamilyFallback : t6);
    this[height$] = (t6$ = height, t6$ == null ? textStyle.height : t6$);
    this[fontSize$] = (t6$0 = fontSize, t6$0 == null ? textStyle.fontSize : t6$0);
    this[fontWeight$] = (t6$1 = fontWeight, t6$1 == null ? textStyle.fontWeight : t6$1);
    this[fontStyle$] = (t6$2 = fontStyle, t6$2 == null ? textStyle.fontStyle : t6$2);
    this[debugLabel$] = (t6$3 = debugLabel, t6$3 == null ? textStyle.debugLabel : t6$3);
    this[_package] = package$1;
    strut_style.StrutStyle.__proto__.new.call(this);
    ;
  }).prototype = strut_style.StrutStyle.prototype;
  dart.addTypeTests(strut_style.StrutStyle);
  const fontFamily$ = Symbol("StrutStyle.fontFamily");
  ...
  const _name$4 = dart.privateName(flutter_logo, "_name");
  let C68;
  let C69;
  let C70;
  let C71;
  ...
  flutter_logo.FlutterLogoStyle.markOnly = C68 || CT.C68;
  flutter_logo.FlutterLogoStyle.horizontal = C69 || CT.C69;
  flutter_logo.FlutterLogoStyle.stacked = C70 || CT.C70;
  flutter_logo.FlutterLogoStyle.values = C71 || CT.C71;
  let C72;
  let C73;
  let C74;
  ...
  (flutter_logo.FlutterLogoDecoration.new = function(opts) {
    let lightColor = opts && 'lightColor' in opts ? opts.lightColor : C72 || CT.C72;
    let darkColor = opts && 'darkColor' in opts ? opts.darkColor : C73 || CT.C73;
    let textColor = opts && 'textColor' in opts ? opts.textColor : C74 || CT.C74;
    let style = opts && 'style' in opts ? opts.style : C68 || CT.C68;
    let margin = opts && 'margin' in opts ? opts.margin : C36 || CT.C36;
  ...
  const lightColor$ = Symbol("FlutterLogoDecoration.lightColor");
  const darkColor$ = Symbol("FlutterLogoDecoration.darkColor");
  const textColor$ = Symbol("FlutterLogoDecoration.textColor");
  const style$0 = Symbol("FlutterLogoDecoration.style");
  const margin$ = Symbol("FlutterLogoDecoration.margin");
  ...
  flutter_logo._FlutterLogoPainter = class _FlutterLogoPainter extends decoration.BoxPainter {
    [_prepareText]() {
      ...
      let textSize = this[_textPainter].getBoxesForSelection(C75 || CT.C75)[$single];
    ...
    [_paintLogo](canvas, rect) {
      ...
      let lightPaint = (t6 = new ui.Paint.new(), t6.color = this[_config$].lightColor.withOpacity(0.8), t6);
      let mediumPaint = (t6$ = new ui.Paint.new(), t6$.color = this[_config$].lightColor, t6$);
      let darkPaint = (t6$0 = new ui.Paint.new(), t6$0.color = this[_config$].darkColor, t6$0);
      let triangleGradient = ui.Gradient.linear(C77 || CT.C77, C78 || CT.C78, JSArrayOfColor().of([C79 || CT.C79, C80 || CT.C80, C81 || CT.C81, C82 || CT.C82, C83 || CT.C83, C84 || CT.C84, C85 || CT.C85, C86 || CT.C86, C87 || CT.C87]), JSArrayOfdouble().of([0.269, 0.4093, 0.4972, 0.5708, 0.6364, 0.6968, 0.7533, 0.8058, 0.8219]));
      let trianglePaint = (t6$1 = new ui.Paint.new(), t6$1.shader = triangleGradient, t6$1.blendMode = ui.BlendMode.multiply, t6$1);
      let rectangleGradient = ui.Gradient.linear(C88 || CT.C88, C89 || CT.C89, JSArrayOfColor().of([C90 || CT.C90, C91 || CT.C91, C92 || CT.C92, C93 || CT.C93, C94 || CT.C94, C95 || CT.C95, C96 || CT.C96, C97 || CT.C97, C98 || CT.C98]), JSArrayOfdouble().of([0.4588, 0.5509, 0.6087, 0.657, 0.7001, 0.7397, 0.7768, 0.8113, 0.8219]));
      let rectanglePaint = (t6$2 = new ui.Paint.new(), t6$2.shader = rectangleGradient, t6$2.blendMode = ui.BlendMode.multiply, t6$2);
      let topBeam = (t6$3 = ui.Path.new(), t6$3.moveTo(37.7, 128.9), t6$3.lineTo(9.8, 101.0), t6$3.lineTo(100.4, 10.4), t6$3.lineTo(156.2, 10.4), t6$3);
      canvas.drawPath(topBeam, lightPaint);
      let middleBeam = (t6$4 = ui.Path.new(), t6$4.moveTo(156.2, 94.0), t6$4.lineTo(100.4, 94.0), t6$4.lineTo(79.5, 114.9), t6$4.lineTo(107.4, 142.8), t6$4);
      canvas.drawPath(middleBeam, lightPaint);
      let bottomBeam = (t6$5 = ui.Path.new(), t6$5.moveTo(79.5, 170.7), t6$5.lineTo(100.4, 191.6), t6$5.lineTo(156.2, 191.6), t6$5.lineTo(156.2, 191.6), t6$5.lineTo(107.4, 142.8), t6$5);
      canvas.drawPath(bottomBeam, darkPaint);
      canvas.save();
      canvas.transform(_native_typed_data.NativeFloat64List.fromList(C99 || CT.C99));
      canvas.drawRect(C100 || CT.C100, mediumPaint);
      canvas.restore();
      let triangle = (t6$6 = ui.Path.new(), t6$6.moveTo(79.5, 170.7), t6$6.lineTo(120.9, 156.4), t6$6.lineTo(107.4, 142.8), t6$6);
      canvas.drawPath(triangle, trianglePaint);
      let rectangle = (t6$7 = ui.Path.new(), t6$7.moveTo(107.4, 142.8), t6$7.lineTo(79.5, 170.7), t6$7.lineTo(86.1, 177.3), t6$7.lineTo(114.0, 149.4), t6$7);
    ...
    paint(canvas, offset, configuration) {
      ...
      if (dart.notNull(this[_config$][_position$]) > 0.0) {
        logoSize = C101 || CT.C101;
      } else if (dart.notNull(this[_config$][_position$]) < 0.0) {
        logoSize = C102 || CT.C102;
      } else {
        logoSize = C103 || CT.C103;
      }
      ...
      if (dart.notNull(this[_config$][_opacity$]) < 1.0) {
        canvas.saveLayer(offset['&'](canvasSize), (t6 = new ui.Paint.new(), t6.colorFilter = new ui.ColorFilter.mode((C104 || CT.C104).withOpacity(this[_config$][_opacity$]), ui.BlendMode.modulate), t6));
      }
      if (this[_config$][_position$] !== 0.0) {
        if (dart.notNull(this[_config$][_position$]) > 0.0) {
          ...
          if (dart.notNull(this[_config$][_position$]) < 1.0) {
            ...
            let path = (t6$ = ui.Path.new(), t6$.moveTo(center.dx, center.dy), t6$.lineTo(dart.notNull(center.dx) + dart.notNull(rect.width), dart.notNull(center.dy) - dart.notNull(rect.width)), t6$.lineTo(dart.notNull(center.dx) + dart.notNull(rect.width), dart.notNull(center.dy) + dart.notNull(rect.width)), t6$.close(), t6$);
          ...
          this[_textPainter].paint(canvas, ui.Offset.zero);
          if (dart.notNull(this[_config$][_position$]) > -1.0) {
            canvas.drawRect(this[_textBoundingRect].inflate(dart.notNull(this[_textBoundingRect].width) * 0.5), (t6$0 = new ui.Paint.new(), t6$0.blendMode = ui.BlendMode.modulate, t6$0.shader = ui.Gradient.linear(new ui.Offset.new(dart.notNull(this[_textBoundingRect].width) * -0.5, 0.0), new ui.Offset.new(dart.notNull(this[_textBoundingRect].width) * 1.5, 0.0), JSArrayOfColor().of([C104 || CT.C104, C104 || CT.C104, C105 || CT.C105, C105 || CT.C105]), JSArrayOfdouble().of([0.0, math.max(core.double, 0.0, this[_config$][_position$][$abs]() - 0.1), math.min(core.double, this[_config$][_position$][$abs]() + 0.1, 1.0), 1.0])), t6$0));
          }
          canvas.restore();
        }
      }
  ...
  shader_warm_up.DefaultShaderWarmUp = class DefaultShaderWarmUp extends shader_warm_up.ShaderWarmUp {
    ...
    warmUpOnCanvas(canvas) {
      return async.async(dart.void, (function* warmUpOnCanvas() {
        ...
        let rrect = C106 || CT.C106;
        let rrectPath = (t6 = ui.Path.new(), t6.addRRect(rrect), t6);
        let circlePath = (t6$ = ui.Path.new(), t6$.addOval(new ui.Rect.fromCircle({center: C107 || CT.C107, radius: 20.0})), t6$);
        ...
        let paints = JSArrayOfPaint().of([(t6$0 = new ui.Paint.new(), t6$0.isAntiAlias = true, t6$0.style = ui.PaintingStyle.fill, t6$0), (t6$1 = new ui.Paint.new(), t6$1.isAntiAlias = false, t6$1.style = ui.PaintingStyle.fill, t6$1), (t6$2 = new ui.Paint.new(), t6$2.isAntiAlias = true, t6$2.style = ui.PaintingStyle.stroke, t6$2.strokeWidth = 10.0, t6$2), (t6$3 = new ui.Paint.new(), t6$3.isAntiAlias = true, t6$3.style = ui.PaintingStyle.stroke, t6$3.strokeWidth = 0.1, t6$3)]);
        ...
        canvas.restore();
        canvas.translate(0.0, this.drawCallSpacing);
        let paragraphBuilder = (t6$4 = ui.ParagraphBuilder.new(new _engine.EngineParagraphStyle.new({textDirection: ui.TextDirection.ltr})), t6$4.pushStyle(new _engine.EngineTextStyle.new({color: black})), t6$4.addText("_"), t6$4);
        let paragraph = (t6$5 = paragraphBuilder.build(), t6$5.layout(C108 || CT.C108), t6$5);
        canvas.drawParagraph(paragraph, C109 || CT.C109);
        for (let fraction of JSArrayOfdouble().of([0.0, 0.5])) {
          t6$6 = canvas;
          t6$6.save();
          t6$6.translate(fraction, fraction);
          t6$6.clipRRect(new ui.RRect.fromLTRBR(8.0, 8.0, 328.0, 248.0, C110 || CT.C110));
          t6$6.drawRect(C111 || CT.C111, new ui.Paint.new());
          t6$6.restore();
          t6$6;
          canvas.translate(this.drawCallSpacing, 0.0);
        }
  ...
  (shader_warm_up.DefaultShaderWarmUp.new = function(opts) {
    ...
    let canvasSize = opts && 'canvasSize' in opts ? opts.canvasSize : C41 || CT.C41;
  ...
  const drawCallSpacing$ = Symbol("DefaultShaderWarmUp.drawCallSpacing");
  const canvasSize$ = Symbol("DefaultShaderWarmUp.canvasSize");
  ...
  const size$0 = Symbol("PlaceholderDimensions.size");
  const alignment$1 = Symbol("PlaceholderDimensions.alignment");
  const baselineOffset$ = Symbol("PlaceholderDimensions.baselineOffset");
  const baseline$0 = Symbol("PlaceholderDimensions.baseline");
  ...
  text_painter.TextWidthBasis.parent = C112 || CT.C112;
  text_painter.TextWidthBasis.longestLine = C113 || CT.C113;
  text_painter.TextWidthBasis.values = C114 || CT.C114;
  ...
  text_painter.TextPainter = class TextPainter extends core.Object {
    ...
    set text(value) {
      let t6, t6$;
      if (!(value == null || dart.test(value.debugAssertIsValid()))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 177, 12, "value == null || value.debugAssertIsValid()");
      if (dart.equals(this[_text], value)) return;
      if (!dart.equals((t6 = this[_text], t6 == null ? null : t6.style), (t6$ = value, t6$ == null ? null : t6$.style))) this[_layoutTemplate] = null;
      this[_text] = value;
    ...
    set textAlign(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 195, 12, "value != null");
    ...
    set textScaleFactor(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 238, 12, "value != null");
    ...
    set ellipsis(value) {
      if (!(value == null || value[$isNotEmpty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 266, 12, "t(value == null || value.isNotEmp");
    ...
    set maxLines(value) {
      if (!(value == null || dart.notNull(value) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 296, 12, "t(value == null || value >");
    ...
    set textWidthBasis(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 332, 12, "t(value != nu");
    ...
    setPlaceholderDimensions(value) {
      ...
      }, VoidToint())() == value[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 374, 12, "t(() {\n      int placeholderCount = 0;\n      text.visitChildren((InlineSpan span) {\n        if (span is PlaceholderSpan) {\n          placeholderCount += 1;\n        }\n        return true;\n      });\n      return placeholderCount;\n    }() == value.leng");
    ...
    [_createParagraphStyle](defaultTextDirection) {
      ...
      if (!(this.textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 393, 12, "t(textAlign != nu");
      if (!(this.textDirection != null || defaultTextDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 394, 12, "t(textDirection != null || defaultTextDirection != nu");
      t6$ = (t6 = this[_text].style, t6 == null ? null : t6.getParagraphStyle({textAlign: this.textAlign, textDirection: (t7 = this.textDirection, t7 == null ? defaultTextDirection : t7), textScaleFactor: this.textScaleFactor, maxLines: this[_maxLines], ellipsis: this[_ellipsis], locale: this[_locale], strutStyle: this[_strutStyle]}));
      return t6$ == null ? new _engine.EngineParagraphStyle.new({textAlign: this.textAlign, textDirection: (t7$ = this.textDirection, t7$ == null ? defaultTextDirection : t7$), maxLines: this.maxLines, ellipsis: this.ellipsis, locale: this.locale}) : t6$;
    }
    get preferredLineHeight() {
      ...
      if (this[_layoutTemplate] == null) {
        ...
        if ((t6 = this.text, t6 == null ? null : t6.style) != null) builder.pushStyle(this.text.style.getTextStyle({textScaleFactor: this.textScaleFactor}));
        builder.addText(" ");
        this[_layoutTemplate] = (t6$ = builder.build(), t6$.layout(C116 || CT.C116), t6$);
      }
    ...
    get minIntrinsicWidth() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 454, 12, "t(!_needsLayo");
      return this[_applyFloatingPointHack](this[_paragraph].minIntrinsicWidth);
    }
    get maxIntrinsicWidth() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 462, 12, "t(!_needsLayo");
      return this[_applyFloatingPointHack](this[_paragraph].maxIntrinsicWidth);
    }
    get width() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 470, 12, "t(!_needsLayo");
    ...
    get height() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 480, 12, "t(!_needsLayo");
      return this[_applyFloatingPointHack](this[_paragraph].height);
    }
    get size() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 488, 12, "t(!_needsLayo");
      return new ui.Size.new(this.width, this.height);
    }
    computeDistanceToActualBaseline(baseline) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 497, 12, "t(!_needsLayo");
      if (!(baseline != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 498, 12, "t(baseline != nu");
      switch (baseline) {
        case C117 || CT.C117:
        {
    ...
    get didExceedMaxLines() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 520, 12, "t(!_needsLayo");
    ...
    layout(opts) {
      ...
      if (!(this.text != null)) dart.assertFailed("TextPainter.text must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 536, 12, "t(text != nu");
      if (!(this.textDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 537, 12, "t(textDirection != nu");
    ...
    paint(canvas, offset) {
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 572, 12, "t(() {\n      if (_needsLayout) {\n        throw FlutterError(\n          'TextPainter.paint called when text geometry was not yet calculated.\\n'\n          'Please call layout() before paint() to position the text before painting it.'\n        );\n      }\n      return true;\n    }");
    ...
    get [_emptyOffset]() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 705, 12, "t(!_needsLayo");
      if (!(this.textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 706, 12, "t(textAlign != nu");
      switch (this.textAlign) {
        ...
        case C115 || CT.C115:
        {
          if (!(this.textDirection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 716, 16, "t(textDirection != nu");
        ...
        case C123 || CT.C123:
        {
          if (!(this.textDirection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 725, 16, "t(textDirection != nu");
          switch (this.textDirection) {
            case C8 || CT.C8:
            {
              return ui.Offset.zero;
    ...
    [_computeCaretMetrics](position, caretPrototype) {
      let t6, t6$;
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 767, 12, "t(!_needsLayo");
      if (dart.equals(position, this[_previousCaretPosition]) && dart.equals(caretPrototype, this[_previousCaretPrototype])) return;
      let offset = position.offset;
      if (!(position.affinity != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 771, 12, "t(position.affinity != nu");
      let rect = null;
      switch (position.affinity) {
        case C124 || CT.C124:
        {
          {
            rect = (t6 = this[_getRectFromUpstream](offset, caretPrototype), t6 == null ? this[_getRectFromDownstream](offset, caretPrototype) : t6);
            break;
          }
        }
        case C76 || CT.C76:
        {
          {
            rect = (t6$ = this[_getRectFromDownstream](offset, caretPrototype), t6$ == null ? this[_getRectFromUpstream](offset, caretPrototype) : t6$);
            break;
          }
        }
      }
    ...
    getBoxesForSelection(selection) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 799, 12, "t(!_needsLayo");
      return this[_paragraph].getBoxesForRange(selection.start, selection.end);
    }
    getPositionForOffset(offset) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 805, 12, "t(!_needsLayo");
      return this[_paragraph].getPositionForOffset(offset);
    }
    getWordBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 817, 12, "t(!_needsLayo");
    ...
    computeLineMetrics() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 838, 12, "t(!_needsLayo");
      return this[_paragraph].computeLineMetrics();
    }
  };
  (text_painter.TextPainter.new = function(opts) {
    let text = opts && 'text' in opts ? opts.text : null;
    let textAlign = opts && 'textAlign' in opts ? opts.textAlign : C115 || CT.C115;
    let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
    let textScaleFactor = opts && 'textScaleFactor' in opts ? opts.textScaleFactor : 1;
    ...
    let textWidthBasis = opts && 'textWidthBasis' in opts ? opts.textWidthBasis : C112 || CT.C112;
    this[_paragraph] = null;
    this[_needsLayout] = true;
    this[_layoutTemplate] = null;
  ...
  rounded_rectangle_border.RoundedRectangleBorder = class RoundedRectangleBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this.borderRadius.resolve(textDirection).toRRect(rect).deflate(this.side.width));
      return t6;
    }
    getOuterPath(rect, opts) {
      let t6;
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this.borderRadius.resolve(textDirection).toRRect(rect));
      return t6;
    }
    paint(canvas, rect, opts) {
      let t6;
  ...
  const side$3 = Symbol("RoundedRectangleBorder.side");
  const borderRadius$1 = Symbol("RoundedRectangleBorder.borderRadius");
  ...
  rounded_rectangle_border._RoundedRectangleToCircleBorder = class _RoundedRectangleToCircleBorder extends borders$.ShapeBorder {
    ...
    getInnerPath(rect, opts) {
      ...
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this[_adjustBorderRadius$](rect, textDirection).toRRect(this[_adjustRect$](rect)).deflate(this.side.width));
      return t6;
    }
    getOuterPath(rect, opts) {
      let t6;
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      t6 = ui.Path.new();
      t6.addRRect(this[_adjustBorderRadius$](rect, textDirection).toRRect(this[_adjustRect$](rect)));
      return t6;
    }
    paint(canvas, rect, opts) {
      let t6;
  ...
  (colors.ColorProperty.new = function(name, value, opts) {
    let showName = opts && 'showName' in opts ? opts.showName : true;
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C48 || CT.C48;
    let style = opts && 'style' in opts ? opts.style : C125 || CT.C125;
    let level = opts && 'level' in opts ? opts.level : C49 || CT.C49;
  ...
  const text$0 = Symbol("InlineSpanSemanticsInformation.text");
  const semanticsLabel$0 = Symbol("InlineSpanSemanticsInformation.semanticsLabel");
  const recognizer$0 = Symbol("InlineSpanSemanticsInformation.recognizer");
  const isPlaceholder$ = Symbol("InlineSpanSemanticsInformation.isPlaceholder");
  const requiresOwnNode = Symbol("InlineSpanSemanticsInformation.requiresOwnNode");
  ...
  borders$.BorderStyle.none = C5 || CT.C5;
  borders$.BorderStyle.solid = C7 || CT.C7;
  borders$.BorderStyle.values = C136 || CT.C136;
  let C137;
  borders$.BorderSide = class BorderSide extends core.Object {
    ...
    copyWith(opts) {
      ...
      return new borders$.BorderSide.new({color: (t6 = color, t6 == null ? this.color : t6), width: (t6$ = width, t6$ == null ? this.width : t6$), style: (t6$0 = style, t6$0 == null ? this.style : t6$0)});
    }
    scale(t) {
  ...
  const color$ = Symbol("BorderSide.color");
  const width$ = Symbol("BorderSide.width");
  const style$1 = Symbol("BorderSide.style");
  ...
  borders$._CompoundBorder = class _CompoundBorder extends borders$.ShapeBorder {
    ...
    add(other, opts) {
      ...
      if (!borders$._CompoundBorder.is(other)) {
        ...
        let merged = (t6 = ours.add(other, {reversed: reversed}), t6 == null ? other.add(ours, {reversed: !dart.test(reversed)}) : t6);
        if (merged != null) {
          let result = (() => {
            let t6 = JSArrayOfShapeBorder().of([]);
            for (let t7 of this.borders)
              t6[$add](t7);
            return t6;
          })();
      ...
      let mergedBorders = (() => {
        let t8 = JSArrayOfShapeBorder().of([]);
        if (dart.test(reversed)) for (let t9 of this.borders)
          t8[$add](t9);
        if (borders$._CompoundBorder.is(other))
          for (let t10 of other.borders)
            t8[$add](t10);
        else
          t8[$add](other);
        if (!dart.test(reversed)) for (let t11 of this.borders)
          t8[$add](t11);
        return t8;
      })();
    ...
    static lerp(a, b, t) {
      ...
      for (let index = 0; index < length; index = index + 1) {
        ...
        if (localA != null && localB != null) {
          let localResult = (t12 = localA.lerpTo(localB, t), t12 == null ? localB.lerpFrom(localA, t) : t12);
          if (localResult != null) {
  ...
  borders$.paintBorder = function paintBorder(canvas, rect, opts) {
    ...
    let paint = (t12 = new ui.Paint.new(), t12.strokeWidth = 0.0, t12);
    let path = ui.Path.new();
    switch (top.style) {
      case C7 || CT.C7:
      {
  ...
  const _name$6 = dart.privateName(box_fit, "_name");
  let C138;
  let C139;
  let C140;
  let C141;
  ...
  box_fit.BoxFit.fill = C138 || CT.C138;
  box_fit.BoxFit.contain = C139 || CT.C139;
  box_fit.BoxFit.cover = C140 || CT.C140;
  box_fit.BoxFit.fitWidth = C141 || CT.C141;
  box_fit.BoxFit.fitHeight = C142 || CT.C142;
  box_fit.BoxFit.none = C143 || CT.C143;
  box_fit.BoxFit.scaleDown = C144 || CT.C144;
  box_fit.BoxFit.values = C145 || CT.C145;
  ...
  box_fit.applyBoxFit = function applyBoxFit(fit, inputSize, outputSize) {
    if (dart.notNull(inputSize.height) <= 0.0 || dart.notNull(inputSize.width) <= 0.0 || dart.notNull(outputSize.height) <= 0.0 || dart.notNull(outputSize.width) <= 0.0) return C146 || CT.C146;
    let sourceSize = null;
  ...
  text_style.TextStyle = class TextStyle extends diagnostics.Diagnosticable {
    ...
    copyWith(opts) {
      let t13, t13$, t13$0, t13$1, t13$2, t13$3, t13$4, t13$5, t13$6, t13$7, t13$8, t13$9, t13$10, t13$11, t13$12, t13$13, t13$14, t13$15, t13$16, t13$17, t13$18;
      ...
      if (!dart.test(dart.fn(() => {
        let t13;
        if (this.debugLabel != null) newDebugLabel = (t13 = debugLabel, t13 == null ? "(" + dart.str(this.debugLabel) + ").copyWith" : t13);
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 723, 12, "t(() {\n      if (this.debugLabel != null)\n        newDebugLabel = debugLabel ?? '(${this.debugLabel}).copyWith';\n      return true;\n    }");
      return new text_style.TextStyle.new({inherit: (t13 = inherit, t13 == null ? this.inherit : t13), color: this.foreground == null && foreground == null ? (t13$ = color, t13$ == null ? this.color : t13$) : null, backgroundColor: this.background == null && background == null ? (t13$0 = backgroundColor, t13$0 == null ? this.backgroundColor : t13$0) : null, fontFamily: (t13$1 = fontFamily, t13$1 == null ? this.fontFamily : t13$1), fontFamilyFallback: (t13$2 = fontFamilyFallback, t13$2 == null ? this.fontFamilyFallback : t13$2), fontSize: (t13$3 = fontSize, t13$3 == null ? this.fontSize : t13$3), fontWeight: (t13$4 = fontWeight, t13$4 == null ? this.fontWeight : t13$4), fontStyle: (t13$5 = fontStyle, t13$5 == null ? this.fontStyle : t13$5), letterSpacing: (t13$6 = letterSpacing, t13$6 == null ? this.letterSpacing : t13$6), wordSpacing: (t13$7 = wordSpacing, t13$7 == null ? this.wordSpacing : t13$7), textBaseline: (t13$8 = textBaseline, t13$8 == null ? this.textBaseline : t13$8), height: (t13$9 = height, t13$9 == null ? this.height : t13$9), locale: (t13$10 = locale, t13$10 == null ? this.locale : t13$10), foreground: (t13$11 = foreground, t13$11 == null ? this.foreground : t13$11), background: (t13$12 = background, t13$12 == null ? this.background : t13$12), shadows: (t13$13 = shadows, t13$13 == null ? this.shadows : t13$13), fontFeatures: (t13$14 = fontFeatures, t13$14 == null ? this.fontFeatures : t13$14), decoration: (t13$15 = decoration, t13$15 == null ? this.decoration : t13$15), decorationColor: (t13$16 = decorationColor, t13$16 == null ? this.decorationColor : t13$16), decorationStyle: (t13$17 = decorationStyle, t13$17 == null ? this.decorationStyle : t13$17), decorationThickness: (t13$18 = decorationThickness, t13$18 == null ? this.decorationThickness : t13$18), debugLabel: newDebugLabel});
    }
    apply(opts) {
      let t13, t13$, t13$0, t13$1, t13$2, t13$3, t13$4;
      let color = opts && 'color' in opts ? opts.color : null;
      let backgroundColor = opts && 'backgroundColor' in opts ? opts.backgroundColor : null;
      let decoration = opts && 'decoration' in opts ? opts.decoration : null;
      let decorationColor = opts && 'decorationColor' in opts ? opts.decorationColor : null;
      ...
      return new text_style.TextStyle.new({inherit: this.inherit, color: this.foreground == null ? (t13 = color, t13 == null ? this.color : t13) : null, backgroundColor: this.background == null ? (t13$ = backgroundColor, t13$ == null ? this.backgroundColor : t13$) : null, fontFamily: (t13$0 = fontFamily, t13$0 == null ? this.fontFamily : t13$0), fontFamilyFallback: (t13$1 = fontFamilyFallback, t13$1 == null ? this.fontFamilyFallback : t13$1), fontSize: this.fontSize == null ? null : dart.notNull(this.fontSize) * dart.notNull(fontSizeFactor) + dart.notNull(fontSizeDelta), fontWeight: this.fontWeight == null ? null : ui.FontWeight.values[$_get](dart.asInt((dart.notNull(this.fontWeight.index) + dart.notNull(fontWeightDelta))[$clamp](0, dart.notNull(ui.FontWeight.values[$length]) - 1))), fontStyle: this.fontStyle, letterSpacing: this.letterSpacing == null ? null : dart.notNull(this.letterSpacing) * dart.notNull(letterSpacingFactor) + dart.notNull(letterSpacingDelta), wordSpacing: this.wordSpacing == null ? null : dart.notNull(this.wordSpacing) * dart.notNull(wordSpacingFactor) + dart.notNull(wordSpacingDelta), textBaseline: this.textBaseline, height: this.height == null ? null : dart.notNull(this.height) * dart.notNull(heightFactor) + dart.notNull(heightDelta), locale: this.locale, foreground: this.foreground, background: this.background, shadows: this.shadows, fontFeatures: this.fontFeatures, decoration: (t13$2 = decoration, t13$2 == null ? this.decoration : t13$2), decorationColor: (t13$3 = decorationColor, t13$3 == null ? this.decorationColor : t13$3), decorationStyle: (t13$4 = decorationStyle, t13$4 == null ? this.decorationStyle : t13$4), decorationThickness: this.decorationThickness == null ? null : dart.notNull(this.decorationThickness) * dart.notNull(decorationThicknessFactor) + dart.notNull(decorationThicknessDelta), debugLabel: modifiedDebugLabel});
    }
    merge(other) {
      if (other == null) return this;
      ...
      if (!dart.test(dart.fn(() => {
        let t13, t13$;
        if (other.debugLabel != null || this.debugLabel != null) mergedDebugLabel = "(" + dart.str((t13 = this.debugLabel, t13 == null ? "unknown" : t13)) + ").merge(" + dart.str((t13$ = other.debugLabel, t13$ == null ? "unknown" : t13$)) + ")";
        return true;
    ...
    static lerp(a, b, t) {
      let t13, t13$, t13$0, t13$1, t13$2, t13$3, t13$4, t13$5, t14, t13$6, t14$, t13$7, t14$0, t13$8, t14$1, t13$9, t13$10, t13$11;
      ...
      if (!dart.test(dart.fn(() => {
        ...
        lerpDebugLabel = "lerp(" + dart.str((t13$ = (t13 = a, t13 == null ? null : t13.debugLabel), t13$ == null ? "unknown" : t13$)) + " ⎯" + t[$toStringAsFixed](1) + "→ " + dart.str((t13$1 = (t13$0 = b, t13$0 == null ? null : t13$0.debugLabel), t13$1 == null ? "unknown" : t13$1)) + ")";
        return true;
      ...
      return new text_style.TextStyle.new({inherit: b.inherit, color: a.foreground == null && b.foreground == null ? ui.Color.lerp(a.color, b.color, t) : null, backgroundColor: a.background == null && b.background == null ? ui.Color.lerp(a.backgroundColor, b.backgroundColor, t) : null, fontFamily: dart.notNull(t) < 0.5 ? a.fontFamily : b.fontFamily, fontFamilyFallback: dart.notNull(t) < 0.5 ? a.fontFamilyFallback : b.fontFamilyFallback, fontSize: ui.lerpDouble((t13 = a.fontSize, t13 == null ? b.fontSize : t13), (t13$ = b.fontSize, t13$ == null ? a.fontSize : t13$), t), fontWeight: ui.FontWeight.lerp(a.fontWeight, b.fontWeight, t), fontStyle: dart.notNull(t) < 0.5 ? a.fontStyle : b.fontStyle, letterSpacing: ui.lerpDouble((t13$0 = a.letterSpacing, t13$0 == null ? b.letterSpacing : t13$0), (t13$1 = b.letterSpacing, t13$1 == null ? a.letterSpacing : t13$1), t), wordSpacing: ui.lerpDouble((t13$2 = a.wordSpacing, t13$2 == null ? b.wordSpacing : t13$2), (t13$3 = b.wordSpacing, t13$3 == null ? a.wordSpacing : t13$3), t), textBaseline: dart.notNull(t) < 0.5 ? a.textBaseline : b.textBaseline, height: ui.lerpDouble((t13$4 = a.height, t13$4 == null ? b.height : t13$4), (t13$5 = b.height, t13$5 == null ? a.height : t13$5), t), locale: dart.notNull(t) < 0.5 ? a.locale : b.locale, foreground: a.foreground != null || b.foreground != null ? dart.notNull(t) < 0.5 ? (t13$6 = a.foreground, t13$6 == null ? (t14 = new ui.Paint.new(), t14.color = a.color, t14) : t13$6) : (t13$7 = b.foreground, t13$7 == null ? (t14$ = new ui.Paint.new(), t14$.color = b.color, t14$) : t13$7) : null, background: a.background != null || b.background != null ? dart.notNull(t) < 0.5 ? (t13$8 = a.background, t13$8 == null ? (t14$0 = new ui.Paint.new(), t14$0.color = a.backgroundColor, t14$0) : t13$8) : (t13$9 = b.background, t13$9 == null ? (t14$1 = new ui.Paint.new(), t14$1.color = b.backgroundColor, t14$1) : t13$9) : null, shadows: dart.notNull(t) < 0.5 ? a.shadows : b.shadows, fontFeatures: dart.notNull(t) < 0.5 ? a.fontFeatures : b.fontFeatures, decoration: dart.notNull(t) < 0.5 ? a.decoration : b.decoration, decorationColor: ui.Color.lerp(a.decorationColor, b.decorationColor, t), decorationStyle: dart.notNull(t) < 0.5 ? a.decorationStyle : b.decorationStyle, decorationThickness: ui.lerpDouble((t13$10 = a.decorationThickness, t13$10 == null ? b.decorationThickness : t13$10), (t13$11 = b.decorationThickness, t13$11 == null ? a.decorationThickness : t13$11), t), debugLabel: lerpDebugLabel});
    }
    getTextStyle(opts) {
      let t14, t13;
      let textScaleFactor = opts && 'textScaleFactor' in opts ? opts.textScaleFactor : 1;
      return new _engine.EngineTextStyle.new({color: this.color, decoration: this.decoration, decorationColor: this.decorationColor, decorationStyle: this.decorationStyle, decorationThickness: this.decorationThickness, fontWeight: this.fontWeight, fontStyle: this.fontStyle, textBaseline: this.textBaseline, fontFamily: this.fontFamily, fontFamilyFallback: this.fontFamilyFallback, fontSize: this.fontSize == null ? null : dart.notNull(this.fontSize) * dart.notNull(textScaleFactor), letterSpacing: this.letterSpacing, wordSpacing: this.wordSpacing, height: this.height, locale: this.locale, foreground: this.foreground, background: (t13 = this.background, t13 == null ? this.backgroundColor != null ? (t14 = new ui.Paint.new(), t14.color = this.backgroundColor, t14) : null : t13), shadows: this.shadows, fontFeatures: this.fontFeatures});
    }
    getParagraphStyle(opts) {
      ...
      return new _engine.EngineParagraphStyle.new({textAlign: textAlign, textDirection: textDirection, fontWeight: (t13 = fontWeight, t13 == null ? this.fontWeight : t13), fontStyle: (t13$ = fontStyle, t13$ == null ? this.fontStyle : t13$), fontFamily: (t13$0 = fontFamily, t13$0 == null ? this.fontFamily : t13$0), fontSize: dart.notNull((t13$2 = (t13$1 = fontSize, t13$1 == null ? this.fontSize : t13$1), t13$2 == null ? 14 : t13$2)) * dart.notNull(textScaleFactor), height: (t13$3 = height, t13$3 == null ? this.height : t13$3), strutStyle: strutStyle == null ? null : new _engine.EngineStrutStyle.new({fontFamily: strutStyle.fontFamily, fontFamilyFallback: strutStyle.fontFamilyFallback, fontSize: strutStyle.fontSize == null ? null : dart.notNull(strutStyle.fontSize) * dart.notNull(textScaleFactor), height: strutStyle.height, leading: strutStyle.leading, fontWeight: strutStyle.fontWeight, fontStyle: strutStyle.fontStyle, forceStrutHeight: strutStyle.forceStrutHeight}), maxLines: maxLines, ellipsis: ellipsis, locale: locale});
    }
    compareTo(other) {
      if (this === other) return basic_types.RenderComparison.identical;
    ...
    debugFillProperties(properties, opts) {
      ...
      if (this.debugLabel != null) properties.add(new diagnostics.MessageProperty.new(dart.str(prefix) + "debugLabel", this.debugLabel));
      let styles = JSArrayOfDiagnosticsNode().of([]);
      styles[$add](new colors.ColorProperty.new(dart.str(prefix) + "color", this.color, {defaultValue: null}));
      styles[$add](new colors.ColorProperty.new(dart.str(prefix) + "backgroundColor", this.backgroundColor, {defaultValue: null}));
      styles[$add](new diagnostics.StringProperty.new(dart.str(prefix) + "family", this.fontFamily, {defaultValue: null, quoted: false}));
      styles[$add](new (IterablePropertyOfString()).new(dart.str(prefix) + "familyFallback", this.fontFamilyFallback, {defaultValue: null}));
      styles[$add](new diagnostics.DoubleProperty.new(dart.str(prefix) + "size", this.fontSize, {defaultValue: null}));
      let weightDescription = null;
      ...
      if (this.decoration != null || this.decorationColor != null || this.decorationStyle != null || this.decorationThickness != null) {
        ...
        if (!dart.test(decorationDescription[$isNotEmpty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1250, 14, "ssert(decorationDescription.isNo");
  ...
  const fontFeatures$ = Symbol("TextStyle.fontFeatures");
  ...
  box_shadow.BoxShadow = class BoxShadow extends ui.Shadow {
    ...
    toPaint() {
      let t13;
      let result = (t13 = new ui.Paint.new(), t13.color = this.color, t13.maskFilter = new ui.MaskFilter.blur(ui.BlurStyle.normal, this.blurSigma), t13);
      if (!dart.test(dart.fn(() => {
  ...
  (box_shadow.BoxShadow.new = function(opts) {
    let color = opts && 'color' in opts ? opts.color : C6 || CT.C6;
    let offset = opts && 'offset' in opts ? opts.offset : C148 || CT.C148;
  ...
  box_decoration.BoxDecoration = class BoxDecoration extends decoration.Decoration {
    ...
    copyWith(opts) {
      let t13, t13$, t13$0, t13$1, t13$2, t13$3, t13$4, t13$5;
      let color = opts && 'color' in opts ? opts.color : null;
      let image = opts && 'image' in opts ? opts.image : null;
      ...
      return new box_decoration.BoxDecoration.new({color: (t13 = color, t13 == null ? this.color : t13), image: (t13$ = image, t13$ == null ? this.image : t13$), border: (t13$0 = border, t13$0 == null ? this.border : t13$0), borderRadius: (t13$1 = borderRadius, t13$1 == null ? this.borderRadius : t13$1), boxShadow: (t13$2 = boxShadow, t13$2 == null ? this.boxShadow : t13$2), gradient: (t13$3 = gradient, t13$3 == null ? this.gradient : t13$3), backgroundBlendMode: (t13$4 = backgroundBlendMode, t13$4 == null ? this.backgroundBlendMode : t13$4), shape: (t13$5 = shape, t13$5 == null ? this.shape : t13$5)});
    }
    debugAssertIsValid() {
      if (!(!dart.equals(this.shape, box_border.BoxShape.circle) || this.borderRadius == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 127, 12, "shape != BoxShape.circle ||\n          borderRadius == null");
      return super.debugAssertIsValid();
    }
    get padding() {
      let t13;
      t13 = this.border;
      return t13 == null ? null : t13.dimensions;
    }
    scale(factor) {
      let t13;
      return new box_decoration.BoxDecoration.new({color: ui.Color.lerp(null, this.color, factor), image: this.image, border: box_border.BoxBorder.lerp(null, this.border, factor), borderRadius: border_radius.BorderRadiusGeometry.lerp(null, this.borderRadius, factor), boxShadow: box_shadow.BoxShadow.lerpList(null, this.boxShadow, factor), gradient: (t13 = this.gradient, t13 == null ? null : t13.scale(factor)), shape: this.shape});
    }
    get isComplex() {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 271, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b.scale(t);
      if (b == null) return a.scale(1.0 - dart.notNull(t));
      if (t === 0.0) return a;
    ...
    debugFillProperties(properties) {
      ...
      super.debugFillProperties(properties);
      t13 = properties;
      t13.defaultDiagnosticsTreeStyle = diagnostics.DiagnosticsTreeStyle.whitespace;
      t13.emptyBodyDescription = "<no decorations specified>";
      t13;
    ...
    hitTest(size, position, opts) {
      let textDirection = opts && 'textDirection' in opts ? opts.textDirection : null;
      if (!(this.shape != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 340, 12, "shape != null");
      if (!dart.test(ui.Offset.zero['&'](size).contains(position))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 341, 12, "(Offset.zero & size).contains(position)");
      switch (this.shape) {
        case C1 || CT.C1:
        {
      ...
      if (!(this.shape != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 355, 12, "shape != null");
      return null;
    }
    createBoxPainter(onChanged) {
      if (onChanged === void 0) onChanged = null;
      if (!(onChanged != null || this.image == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 361, 12, "onChanged != null || image == null");
  ...
  (box_decoration.BoxDecoration.new = function(opts) {
    ...
    this[shape$] = shape;
    if (!(shape != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 94, 15, "shape != null");
    if (!(backgroundBlendMode == null || color != null || gradient != null)) dart.assertFailed("backgroundBlendMode applies to BoxDecoration's background color or " + "gradient, but no color or gradient was provided.", "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 96, 10, "backgroundBlendMode == null || color != null || gradient != null");
  ...
  const color$1 = Symbol("BoxDecoration.color");
  const image$1 = Symbol("BoxDecoration.image");
  const border$ = Symbol("BoxDecoration.border");
  const borderRadius$2 = Symbol("BoxDecoration.borderRadius");
  const boxShadow$ = Symbol("BoxDecoration.boxShadow");
  const gradient$ = Symbol("BoxDecoration.gradient");
  const backgroundBlendMode$ = Symbol("BoxDecoration.backgroundBlendMode");
  const shape$ = Symbol("BoxDecoration.shape");
  ...
  const _decoration$ = dart.privateName(box_decoration, "_decoration");
  ...
  box_decoration._BoxDecorationPainter = class _BoxDecorationPainter extends decoration.BoxPainter {
    [_getBackgroundPaint](rect, textDirection) {
      if (!(rect != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 377, 12, "rect != null");
      if (!(this[_decoration$].gradient != null || this[_rectForCachedBackgroundPaint] == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 378, 12, "_decoration.gradient != null || _rectForCachedBackgroundPaint == null");
    ...
    [_paintBox](canvas, rect, paint, textDirection) {
      switch (this[_decoration$].shape) {
        case C2 || CT.C2:
        {
          if (!(this[_decoration$].borderRadius == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 400, 16, "_decoration.borderRadius == null");
    ...
    [_paintBackgroundImage](canvas, rect, configuration) {
      ...
      switch (this[_decoration$].shape) {
        case C2 || CT.C2:
        {
          clipPath = (t13 = ui.Path.new(), t13.addOval(rect), t13);
          break;
        }
        case C1 || CT.C1:
        {
          if (this[_decoration$].borderRadius != null) clipPath = (t13$ = ui.Path.new(), t13$.addRRect(this[_decoration$].borderRadius.resolve(configuration.textDirection).toRRect(rect)), t13$);
          break;
        }
      }
    ...
    dispose() {
      let t13;
      t13 = this[_imagePainter];
      t13 == null ? null : t13.dispose();
      super.dispose();
    }
    paint(canvas, offset, configuration) {
      let t13;
      if (!(configuration != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 457, 12, "configuration != null");
      if (!(configuration.size != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 458, 12, "configuration.size != null");
      ...
      t13 = this[_decoration$].border;
      t13 == null ? null : t13.paint(canvas, rect, {shape: this[_decoration$].shape, borderRadius: border_radius.BorderRadius._check(this[_decoration$].borderRadius), textDirection: configuration.textDirection});
    }
    toString() {
  ...
  (box_decoration._BoxDecorationPainter.new = function(_decoration, onChanged) {
    ...
    if (!(_decoration != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_decoration.dart", 369, 14, "_decoration != null");
  ...
  shape_decoration.ShapeDecoration = class ShapeDecoration extends decoration.Decoration {
      ...
      switch (source.shape) {
        ...
        case C1 || CT.C1:
        {
          if (source.borderRadius != null) {
            ...
            shape = new rounded_rectangle_border.RoundedRectangleBorder.new({side: (t13$ = (t13 = source.border, t13 == null ? null : t13.top), t13$ == null ? borders$.BorderSide.none : t13$), borderRadius: source.borderRadius});
          } else {
            shape = (t13$0 = source.border, t13$0 == null ? C150 || CT.C150 : t13$0);
          }
          break;
        }
      }
    ...
    static lerp(a, b, t) {
      ...
      return new shape_decoration.ShapeDecoration.new({color: ui.Color.lerp((t13 = a, t13 == null ? null : t13.color), (t13$ = b, t13$ == null ? null : t13$.color), t), gradient: gradient.Gradient.lerp((t13$0 = a, t13$0 == null ? null : t13$0.gradient), (t13$1 = b, t13$1 == null ? null : t13$1.gradient), t), image: dart.notNull(t) < 0.5 ? a.image : b.image, shadows: box_shadow.BoxShadow.lerpList((t13$2 = a, t13$2 == null ? null : t13$2.shadows), (t13$3 = b, t13$3 == null ? null : t13$3.shadows), t), shape: borders$.ShapeBorder.lerp((t13$4 = a, t13$4 == null ? null : t13$4.shape), (t13$5 = b, t13$5 == null ? null : t13$5.shape), t)});
    }
    _equals(other) {
      if (other == null) return false;
      if (this === other) return true;
  ...
  const color$2 = Symbol("ShapeDecoration.color");
  const gradient$0 = Symbol("ShapeDecoration.gradient");
  const image$2 = Symbol("ShapeDecoration.image");
  const shadows$0 = Symbol("ShapeDecoration.shadows");
  const shape$0 = Symbol("ShapeDecoration.shape");
  ...
  const _decoration$0 = dart.privateName(shape_decoration, "_decoration");
  ...
  shape_decoration._ShapeDecorationPainter = class _ShapeDecorationPainter extends decoration.BoxPainter {
    [_precache](rect, textDirection) {
      ...
      if (this[_interiorPaint] == null && (this[_decoration$0].color != null || this[_decoration$0].gradient != null)) {
        this[_interiorPaint] = new ui.Paint.new();
        if (this[_decoration$0].color != null) this[_interiorPaint].color = this[_decoration$0].color;
      }
      if (this[_decoration$0].gradient != null) this[_interiorPaint].shader = this[_decoration$0].gradient.createShader(rect);
      if (this[_decoration$0].shadows != null) {
        if (this[_shadowCount] == null) {
          this[_shadowCount] = this[_decoration$0].shadows[$length];
          ...
          for (let index = 0; index < dart.notNull(this[_shadowCount]); index = index + 1)
            this[_shadowPaints][$_set](index, this[_decoration$0].shadows[$_get](index).toPaint());
        }
        for (let index = 0; index < dart.notNull(this[_shadowCount]); index = index + 1) {
          let shadow = this[_decoration$0].shadows[$_get](index);
          this[_shadowPaths][$_set](index, this[_decoration$0].shape.getOuterPath(rect.shift(shadow.offset).inflate(shadow.spreadRadius), {textDirection: textDirection}));
        }
      }
      if (this[_interiorPaint] != null || this[_shadowCount] != null) this[_outerPath] = this[_decoration$0].shape.getOuterPath(rect, {textDirection: textDirection});
      if (this[_decoration$0].image != null) this[_innerPath] = this[_decoration$0].shape.getInnerPath(rect, {textDirection: textDirection});
      this[_lastRect] = rect;
    ...
    paint(canvas, offset, configuration) {
      ...
      this[_decoration$0].shape.paint(canvas, rect, {textDirection: textDirection});
    }
  };
  ...
  dart.setFieldSignature(shape_decoration._ShapeDecorationPainter, () => ({
    ...
    [_decoration$0]: dart.finalFieldType(shape_decoration.ShapeDecoration),
