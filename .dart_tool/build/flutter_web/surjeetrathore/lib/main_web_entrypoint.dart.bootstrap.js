...
let modulePaths = {
 ...
 "packages/surjeetrathore/const": "packages/surjeetrathore/const.ddc",
 "packages/surjeetrathore/home": "packages/surjeetrathore/home.ddc",
 "packages/surjeetrathore/main": "packages/surjeetrathore/main.ddc",
 "packages/surjeetrathore/main_web_entrypoint": "packages/surjeetrathore/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/surjeetrathore/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:surjeetrathore/main_web_entrypoint.dart") {
          // Clear static caches.
